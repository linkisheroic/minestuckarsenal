...
import com.natura.minestuckarsenal.object.Gun.Projectile;
...
{
	private static final com.google.common.base.Predicate<Entity> ARROW_TARGETS = Predicates.and(EntitySelectors.NOT_SPECTATING, EntitySelectors.IS_ALIVE, entity -> entity.canBeCollidedWith());
